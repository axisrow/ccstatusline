...
import { TIMEZONE_EDITOR_ACTION } from '../shared/timezone-editor';
import {
    getUsageTimezone,
    setUsageTimezone
...
const UsageTimezoneEditor: React.FC<WidgetEditorProps> = ({ widget, onComplete, onCancel, action }) => {
...
export default UsageTimezoneEditor;
