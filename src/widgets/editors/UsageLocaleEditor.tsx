...
import { LOCALE_EDITOR_ACTION } from '../shared/locale-editor';
import {
    getUsageLocale,
    setUsageLocale
...
const UsageLocaleEditor: React.FC<WidgetEditorProps> = ({ widget, onComplete, onCancel, action }) => {
...
export default UsageLocaleEditor;
